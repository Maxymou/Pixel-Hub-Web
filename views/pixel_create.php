<?php
$page_title = 'Pixel Hub - Créer un pixel';
$current_page = 'pixel_create';
...
<main>
    <div class="create-container">
        ...
        <form action="/pixel/create" method="POST" enctype="multipart/form-data" class="create-form">
            <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload">
                            <div class="image-preview">
                                <img src="/images/placeholder.png" alt="Aperçu du pixel" id="image-preview">
                            </div>
                ...
                <div class="form-section">
                    <div class="form-group">
                        ...
                        <input type="number" id="width" name="width" min="1" max="1000" required>
                    </div>

                    <div class="form-group">
                        <label for="height">Hauteur (pixels)</label>
                        <input type="number" id="height" name="height" min="1" max="1000" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="palette_count" name="palette_count" min="1" max="256" required>
                    </div>
